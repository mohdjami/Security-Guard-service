      ...
      <div className="container px-4 md:px-6">
        <div className="mx-auto max-w-3xl space-y-6">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            At our security-focused website, we understand the importance of
            protecting your personal information. We are committed to
            safeguarding your privacy and ensuring that your data is handled
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Categories of personal data we process. <br />
                Source and specifics of data not directly provided by you.
                ...
                and the legal rights of others. <br />
                2.8 In addition to the specific purposes for which we may
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                <br />
                3.1 Financial transactions relating to our website and services
                may be handled by our payment services providers: PayPal and
                others. We will share transaction data with our payment services
                ...
                out in this section, we may disclose your personal data where
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                ...
                <br />
                <br />
                4.1 Personal data that we process for any purpose or purposes
                shall not be kept for longer than is necessary for that purpose
                or those purposes. <br />
                4.2 We will retain your personal data as follows:
                <br /> Last three IP addresses from which account was accessed -
                valid for registered users
                <br /> IP address and related metadata - valid for all visitors{" "}
                <br />
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold">5. User Rights and Control</h3>
              <p className="text-gray-500 dark:text-gray-400">
                You have the right to access, update, and delete your personal
                information at any time. You can also choose to opt-out of
                certain communications or data processing activities. We respect
                your privacy and will always strive to be transparent about how
                we handle your data.
              </p>
            </div>
          </div>
